...
public class LightSubsystem extends Subsystem {
	...
	public enum Color {
		VIOLET(0.91),DARK_GREEN(0.75),HOT_PINK(0.57),STROBE_TEAMCOLOR2(0.35),SHOT_TEAMCOLOR2(0.33),BREATH_FAST_TEAMCOLOR1(0.31),BEND_TO_BLACK_TEAMCOLOR2(0.17),STROBE_TEAMCOLOR1(0.15),SHOT_TEAMCOLOR1(0.13),LARSON_SCANNER_TEAMCOLOR1(-0.01),BEND_TO_BLACK_TEAMCOLOR1(-0.03),STROBE_WHITE(-0.05),HEARTBEART_WHITE(-0.21),LIGHT_CHASE_RED(-0.31),CONFETTI(-0.87);
		public double value;
